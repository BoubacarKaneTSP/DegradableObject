...
perf stat -B -e cache-references,cache-misses ./test.sh -s Set -t Microbenchmark -p -e -r "50 50 0" -w 10 -u 5 -n 1 -i 1000000 -d 10000
perf stat -B -e cache-references,cache-misses ./test.sh -s SegmentedSkipListSet -t Microbenchmark -p -e -r "50 50 0" -w 10 -u 5 -n 1 -i 1000000 -d 10000
perf stat -B -e cache-references,cache-misses ./test.sh -s ShardedTreeSet -t Microbenchmark -p -e -r "50 50 0" -w 10 -u 5 -n 1 -i 1000000 -d 10000
perf stat -B -e cache-references,cache-misses ./test.sh -s ShardedSet -t Microbenchmark -p -e -r "50 50 0" -w 10 -u 5 -n 1 -i 1000000 -d 10000
#
