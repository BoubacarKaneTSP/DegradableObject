...
CLASSPATH=../java/target/*:../java/target/lib/* java -XX:+UseNUMA -XX:+UseG1GC eu.cloudbutton.dobj.Benchmark.App -set Set -queue Queue -counter Counter -map Map -ratios 0 0 100 0 -nbTest 5 -time 10 -wTime 10 -s -p
