...
CLASSPATH=../java/target/*:../java/target/lib/* java -XX:+UseNUMA -XX:+UseG1GC eu.cloudbutton.dobj.App -set Set -list List -counter Counter -ratios 5 15 30 50 -nbTest 5 -time 10 -wTime 5 -alphaInit 1.315 -alphaMin 1.315 -alphaStep 0.05 -s -p
