...
CLASSPATH=../java/target/*:../java/target/lib/* java -XX:+UseNUMA -XX:+UseG1GC eu.cloudbutton.dobj.Benchmark.App -set ConcurrentSkipListSet -queue ConcurrentLinkedQueue -counter Counter -map ConcurrentHashMap -distribution 100 0 0 0 -nbTest 1 -time 10 -wTime 30 -p
