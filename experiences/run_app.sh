...
CLASSPATH=../java/target/*:../java/target/lib/* java -XX:+UseNUMA -XX:+UseG1GC eu.cloudbutton.dobj.Benchmark.App -set ConcurrentSkipListSet -queue ConcurrentLinkedQueue -counter Counter -map ConcurrentHashMap -distribution 5 15 30 50 -nbTest 5 -time 10 -wTime 30 -s -p
