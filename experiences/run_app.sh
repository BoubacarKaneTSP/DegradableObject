...
CLASSPATH=../java/target/*:../java/target/lib/* java -XX:+UseNUMA -XX:+UseG1GC eu.cloudbutton.dobj.Benchmark.App -set Set -queue Queue -counter Counter -map Map -ratios 5 15 30 50 -nbTest 5 -time 10 -wTime 10 -s -p
