...
CLASSPATH=../java/target/*:../java/target/lib/* java -XX:+UseNUMA -XX:+UseG1GC eu.cloudbutton.dobj.Benchmark.App -set DegradableSet -queue MapQueue -counter DegradableCounter -ratios 5 15 30 50 -nbTest 2 -time 10 -wTime 5 -s -p
