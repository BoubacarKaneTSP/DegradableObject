...
#  python3 rm_file.py $nbUsersInit "Q_M_S_C"
  ...
  python3 compute_avg_throughput.py $nbUsersInit "JUC" "1 8 48"
  python3 compute_avg_throughput.py $nbUsersInit "Q_M_C" "1 8 48"
