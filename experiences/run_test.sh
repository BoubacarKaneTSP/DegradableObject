...
#python3 compute_avg_throughput_microbenchmark.py "ExtendedSegmentedHashSet" "1 32 96"
...
#
#python3 compute_avg_throughput_microbenchmark.py "ConcurrentHashMap" "1 32 96"
#python3 compute_avg_throughput_microbenchmark.py "ExtendedSegmentedHashMap" "1 32 96"
#python3 compute_avg_throughput_microbenchmark.py "ExtendedSegmentedConcurrentHashMap" "1 32 96"
