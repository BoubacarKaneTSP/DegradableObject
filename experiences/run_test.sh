...
##
  perf stat -B -e cache-references,cache-misses ./test.sh -m Map -t Microbe:nchmark -p -e -r "25 25 50" -w $benchmarkTime -u $warmingUpTime -n $nbTest -i $initSize -d $range -g $nbThread
