...
for type in 'AtomicInteger' 'DegradableCounter' 'ConcurrentSkipListSet' 'DegradableSet' 'ConcurrentHashMap' 'DegradableMap' 'ConcurrentLinkedQueue' 'MapQueue' 'DegradableQueue'
  do
    echo $type $ratio
