...
//    private ThreadGroupCustom group;
//
//    /* The context ClassLoader for this thread */
//    private ClassLoaderCustom contextClassLoader;
//
...
//    ThreadLocalCustom.ThreadLocalMapCustom threadLocals = null;
//
//    /*
//     * InheritableThreadLocal values pertaining to this thread. This map is
//     * maintained by the InheritableThreadLocal class.
//     */
//    ThreadLocalCustom.ThreadLocalMapCustom inheritableThreadLocals = null;
//
//    /*
...
//        ThreadCustom me = ThreadCustom.currentThread();
...
//    public static native ThreadCustom currentThread();
//
//    /**
...
//     */
//    private ThreadCustom(ThreadGroupCustom g, Runnable target, String name,
...
//        this.name = name;
//
//        ThreadCustom parent = currentThread();
...
//               what to do. */
//            if (security != null) {
//                g = (ThreadGroupCustom) ((Object) security.getThreadGroup());
//            }
//
...
//                    ThreadLocalCustom.createInheritedMap(parent.inheritableThreadLocals);
...
//     * effect as {@linkplain #ThreadCustom(ThreadGroupCustom,Runnable,String) Thread}
...
//     *         nothing.
//     */
//    public ThreadCustom(Runnable target) {
...
//     */
//    ThreadCustom(Runnable target, AccessControlContext acc) {
...
//     *          thread group
//     */
//    public ThreadCustom(ThreadGroupCustom group, Runnable target) {
...
//     *          thread group
//     */
//    public ThreadCustom(ThreadGroupCustom group, String name) {
...
//     *         the name of the new thread
//     */
//    public ThreadCustom(Runnable target, String name) {
...
//     */
//    public ThreadCustom(ThreadGroupCustom group, Runnable target, String name) {
...
//     * #ThreadCustom(ThreadGroupCustom,Runnable,String)} with the exception of the fact
...
//     *
//     * <p> This constructor is identical to {@link
//     * #ThreadCustom(ThreadGroupCustom,Runnable,String,long)} with the added ability to
...
//     * @see     #start()
//     * @see     #stop()
//     * @see     #ThreadCustom(ThreadGroupCustom, Runnable, String)
//     */
//    @Override
//    public void run() {
//        if (target != null) {
...
//     */
//    private void exit() {
//        if (threadLocals != null && TerminatingThreadLocalCustom.REGISTRY.isPresent()) {
...
//     * @see        #start()
//     * @see        ThreadDeath
//     * @see        ThreadGroupCustom#uncaughtException(ThreadCustom,Throwable)
...
//        if (security != null) {
//            checkAccess();
//            if (this != ThreadCustom.currentThread()) {
...
//                    b.interrupt((Thread) (Object)this);
//                    return;
//                }
//            }
//        }
...
//     * @see        #MAX_PRIORITY
//     * @see        #MIN_PRIORITY
//     * @see        ThreadGroupCustom#getMaxPriority()
//     */
...
//     */
//    public final ThreadGroupCustom getThreadGroup() {
//        return group;
//    }
//
//    /**
...
//     */
//    public static int enumerate(ThreadCustom tarray[]) {
...
//        ThreadGroupCustom group = getThreadGroup();
//        if (group != null) {
...
//     */
//    @CallerSensitive
//    public ClassLoaderCustom getContextClassLoader() {
///*        if (contextClassLoader == null)
//            return null;
//        SecurityManager sm = System.getSecurityManager();
//        if (sm != null) {
//            ClassLoaderCustom.checkClassLoaderPermission(contextClassLoader,
...
//     * @since 1.2
//     */
//    public void setContextClassLoader(ClassLoaderCustom cl) {
//        SecurityManager sm = System.getSecurityManager();
//        if (sm != null) {
...
//            }
//            StackTraceElement[][] stackTraceArray = dumpThreads(new ThreadCustom[] {this});
...
//     * @since 1.5
//     */
//    public static Map<ThreadCustom, StackTraceElement[]> getAllStackTraces() {
//        // check for getStackTrace permission
//        SecurityManager security = System.getSecurityManager();
//        if (security != null) {
//            security.checkPermission(
...
//        ThreadCustom[] threads = getThreads();
//        StackTraceElement[][] traces = dumpThreads(threads);
//        Map<ThreadCustom, StackTraceElement[]> m = new HashMap<>(threads.length);
...
//                            }
//                            try {
//                                Class<?>[] params = {ClassLoaderCustom.class};
...
//    }
//
//    private static native StackTraceElement[][] dumpThreads(ThreadCustom[] threads);
//    private static native ThreadCustom[] getThreads();
//
//    /**
...
//        return (ThreadCustom.State)(Object)jdk.internal.misc.VM.toThreadState(threadStatus);
//    }
//
//    // Added in JSR-166
//
...
//     * @see ThreadGroupCustom#uncaughtException
//     * @since 1.5
//     */
//    @FunctionalInterface
...
//         */
//        void uncaughtException(ThreadCustom t, Throwable e);
//    }
//
...
//     * by the thread's {@link ThreadGroupCustom} object and finally by the default
