 ...
 *
 * <p>A {@link Set} projection of a ConcHashMap may be created
 * (using {@link #newKeySet()} or {@link #newKeySet(int)}), or viewed
 * (using {@link #keySet(Object)} when only keys are of interest, and the
 * mapped values are (perhaps transiently) not used or all take the
 * same mapping value.
 *
 * <p>A ConcHashMap can be used as a scalable frequency map (a
 * form of histogram or multiset) by using {@link
 * java.util.concurrent.atomic.LongAdder} values and initializing via
 * {@link #computeIfAbsent computeIfAbsent}. For example, to add a count
 * to a {@code ConcHashMap<String,LongAdder> freqs}, you can use
 ...
 *
 * <p>ConcHashMaps support a set of sequential and parallel bulk
 ...
 * ConcHashMap are not ordered in any particular way, and may be
 ...
 * from those of ConcHashMap: Any non-null result returned
 ...
 */
public class ConcHashMap<K,V> extends AbstractMap<K,V>
...
//            return Helpers.mapEntryToString(key, val);
     ...
     */
    public ConcHashMap(int initialCapacity) {
     ...
     * @param m the map
     */
    public ConcHashMap(Map<? extends K, ? extends V> m) {
     ...
     * @since 1.6
     */
    public ConcHashMap(int initialCapacity, float loadFactor) {
    ...
    // ConcHashMap-only methods

    /**
     * Returns the number of mappings. This method should be used
     * instead of {@link #size} because a ConcHashMap may
    ...
    /**
     * Creates a new {@link Set} backed by a ConcHashMap
    ...
    public static <K> KeySetView<K,Boolean> newKeySet() {
        return new KeySetView<K,Boolean>
                (new ConcHashMap<K,Boolean>(), Boolean.TRUE);
    }
    ...
    public static <K> KeySetView<K,Boolean> newKeySet(int initialCapacity) {
        return new KeySetView<K,Boolean>
                (new ConcHashMap<K,Boolean>(initialCapacity), Boolean.TRUE);
    }
    ...
    private final void addCount(long x, int check) {
        ...
        if ((cs = counterCells) != null ||
            ...
            if (cs == null || (m = cs.length - 1) < 0 ||
                    (c = cs[ThreadLocRandom.getProbe() & m]) == null ||
                    !(uncontended =
    ...
    private final void fullAddCount(long x, boolean wasUncontended) {
        int h;
        if ((h = ThreadLocRandom.getProbe()) == 0) {
            ThreadLocRandom.localInit();      // force initialization
            h = ThreadLocRandom.getProbe();
            wasUncontended = true;
        }
        ...
        for (;;) {
            ...
            if ((cs = counterCells) != null && (n = cs.length) > 0) {
                ...
                h = ThreadLocRandom.advanceProbe(h);
            }
...
//                    nbBin++;
    ...
    static final class MapEntry<K,V> implements Map.Entry<K,V> {
        ...
        V val;       // non-null
        final ConcHashMap<K,V> map;
        MapEntry(K key, V val, ConcHashMap<K,V> map) {
            this.key = key;
            this.val = val;
            this.map = map;
        }
...
//            return Helpers.mapEntryToString(key, val);
    ...
    static final class EntrySpliterator<K,V> extends Traverser<K,V>
        ...
        final ConcHashMap<K,V> map; // To export MapEntry
        long est;               // size estimate
        EntrySpliterator(Node<K,V>[] tab, int size, int index, int limit,
                         long est, ConcHashMap<K,V> map) {
            super(tab, size, index, limit);
            this.map = map;
            this.est = est;
        }
    ...
    abstract static sealed class CollectionView<K,V,E>
        ...
        private static final long serialVersionUID = 7249069246763182397L;
        final ConcHashMap<K,V> map;
        CollectionView(ConcHashMap<K,V> map)  { this.map = map; }
         ...
         */
        public ConcHashMap<K,V> getMap() { return map; }
    ...
    /**
     * A view of a ConcHashMap as a {@link Set} of keys, in
    ...
    public static final class KeySetView<K,V> extends CollectionView<K,V,K>
        ...
        KeySetView(ConcHashMap<K,V> map, V value) {  // non-public
            super(map);
            this.value = value;
        }
    ...
    /**
     * A view of a ConcHashMap as a {@link Collection} of
    ...
    static final class ValuesView<K,V> extends CollectionView<K,V,V>
        ...
        private static final long serialVersionUID = 2249069246763182397L;
        ValuesView(ConcHashMap<K,V> map) { super(map); }
    ...
    /**
     * A view of a ConcHashMap as a {@link Set} of (key, value)
    ...
    static final class EntrySetView<K,V> extends CollectionView<K,V, Entry<K,V>>
        ...
        private static final long serialVersionUID = 2249069246763182397L;
        EntrySetView(ConcHashMap<K,V> map) { super(map); }
    ...
    private static final long SIZECTL
            = U.objectFieldOffset(ConcHashMap.class, "sizeCtl");
    private static final long TRANSFERINDEX
            = U.objectFieldOffset(ConcHashMap.class, "transferIndex");
    private static final long BASECOUNT
            = U.objectFieldOffset(ConcHashMap.class, "baseCount");
    private static final long CELLSBUSY
            = U.objectFieldOffset(ConcHashMap.class, "cellsBusy");
