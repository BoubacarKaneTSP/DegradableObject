 ...
 */
public class TerminatingThreadLocalCustom<T> extends ThreadLocalCustom<T> {
    ...
    public static void threadTerminated() {
        for (TerminatingThreadLocalCustom<?> ttl : REGISTRY.get()) {
     ...
     */
    public static void register(TerminatingThreadLocalCustom<?> tl) {
        REGISTRY.get().add(tl);
    }
     ...
     */
    private static void unregister(TerminatingThreadLocalCustom<?> tl) {
     ...
     */
    public static final ThreadLocalCustom<Collection<TerminatingThreadLocalCustom<?>>> REGISTRY =
            new ThreadLocalCustom<>() {
                @Override
                protected Collection<TerminatingThreadLocalCustom<?>> initialValue() {
