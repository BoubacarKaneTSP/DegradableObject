 ...
 * A {@code QueueMASP} is an appropriate choice when
 ...
 * the {@code QueueMASP} in another thread.
 *
...
//    @Contended
     ...
     */
    public QueueMASP(Collection<? extends E> c) {
...
//        }
    ...
    public String toString() {
        ...
        restartFromHead: for (;;) {
            ...
            return java.util.concurrent.Helpers.toString(a, size, charLength);
        }*/

        return "toString method not built";
    }
    ...
    public Spliterator<E> spliterator() {
        return new QueueMASP.CLQSpliterator();
    }
